...
```{bash,eval=FALSE}
zcat $COURSES/BIO326/EUK/data_2024/fastq_pass/barcode01/PAW12736_pass_barcode01_e04e4c40_71f9eb67_0.fastq.gz | more
```
...
![](https://github.com/mariesaitou/Bio326/raw/master/docs/assets/Bio326-2023/image1.png){width=80%}
...
```{bash,eval=FALSE}
zcat $COURSES/BIO326/EUK/data_2024/fastq_pass/barcode01/PAW12736_pass_barcode01_e04e4c40_71f9eb67_0.fastq.gz | wc -l
```


![](https://github.com/mariesaitou/Bio326/raw/master/docs/assets/Bio326-2023/image2.png){width=80%}
...
```{bash,eval=FALSE}
zcat $COURSES/BIO326/EUK/data_2024/fastq_pass/barcode01/PAW12736_pass_barcode01_e04e4c40_71f9eb67_0.fastq.gz | sed -n 4p | cut -c 1-5
```
...
## run nanoplot
NanoPlot -t 8  --fastq $COURSES/BIO326/EUK/data_2024/fastq_pass/barcode01/PAW12736_pass_barcode01_e04e4c40_71f9eb67_0.fastq.gz --plots dot  --no_supplementary --no_static --N50 -p before
...
## run nanofilt
gunzip -c $COURSES/BIO326/EUK/data_2024/fastq_pass/barcode01/PAW12736_pass_barcode01_e04e4c40_71f9eb67_0.fastq.gz | NanoFilt -q 10 -l 500 | gzip > cleaned.pig_demodata_2024.fastq.gz
...
## run nanoplot
NanoPlot -t 8  --fastq $COURSES/BIO326/EUK/data_2024/fastq_pass/barcode01/PAW12736_pass_barcode01_e04e4c40_71f9eb67_0.fastq.gz --plots dot  --no_supplementary --no_static --N50 -p after
...
![](https://github.com/mariesaitou/Bio326/raw/master/docs/assets/Bio326-2023/image6.png){width=80%}


![](https://github.com/mariesaitou/Bio326/raw/master/docs/assets/Bio326-2023/image7.png){width=80%}
