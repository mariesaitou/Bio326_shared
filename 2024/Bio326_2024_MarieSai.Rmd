...
First you will select a random variant to investigate


```{bash,eval=FALSE}
#Check the number of variant in the file

NBVAR=$(bcftools index -n cow.vcf)
...
bcftools view -H cow.vcf | sed -n ${RANDOMVAR}p
...
Upload: cow.vcf - downloaded from Orion or the section above as the file to investigate.
