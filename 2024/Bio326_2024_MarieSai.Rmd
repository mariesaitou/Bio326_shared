...
minimap2 -t 8 -a -a /mnt/courses/BIO326/EUK/pig_genome/Sus_scrofa.Sscrofa11.1.dna.toplevel.fa.gz  /mnt/courses/BIO326/EUK/result_2024/cleaned_pig_demodata_BCO1.fastq.gz > pig.sam


# convert the sam file to bam format
samtools view -S -b pig.sam > pig0.bam

## sort the bam file
samtools sort pig0.bam -o pig.bam

# index the bam file
samtools index -M  pig.bam

# Variant Calling using Sniffles
sniffles --input  pig.bam --vcf pig.vcf
